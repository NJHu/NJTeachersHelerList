#
# Be sure to run `pod lib lint NJTeachersHelerList.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of NJTeachersHelerList.'
...
TODO: Add long description of the pod here.
  ...
  # s.resource_bundles = {
  #   'NJTeachersHelerList' => ['NJTeachersHelerList/Assets/*.png']
  # }
